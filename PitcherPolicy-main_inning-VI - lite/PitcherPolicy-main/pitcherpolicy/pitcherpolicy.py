...
if __name__ == "__main__":    
    ...
    pitcher_id = '607536'
    batter_id_list = ['572761','641933','502671','571448','405395','572816','657557','425877','542303']
    states=gen_inning_states(N)
    trans_prob_mat = gen_trans_inning_mat(pitcher_id, batter_id_list)

    s1 = StochasticGame(states, trans_prob_mat)
